...
**This is a preliminary real-time comparison between the semi-parametric nowcasting method evaluated in this project and the other methods submitted to the [German nowcasting hub](https://covid19nowcasthub.de). It is not the official prespecified evaluation the protocol for which can be found [here](https://osf.io/mru75/).**
...
```{r plot-overall-scores, fig.height = 8, fig.width = 8}
plot_scores(
...
```{r plot-location-scores, fig.height = 8, fig.width = 16}
plot_scores(
