...
All models are implemented using the `epinowcast` R package [@epinowcast]. The nowcasting and evaluation pipeline is implemented using the `targets` R package[@targets]. All input data, interim data, and output data are available and should also be fully reproducible from the provided code. Please see the resources section for details. Further details on our methodology are inclued in our [paper](https://epiforecasts.io/eval-germany-sp-nowcasting/paper.pdf).
