...
reference_date_scores <- fread(here("data/scores/reference_date.csv"))
reference_date_scores <- clean_names(reference_date_scores, case = "sentence")
```
...
report_date_scores <- fread(here("data/scores/nowcast_date.csv"))
report_date_scores <- clean_names(report_date_scores, case = "sentence")
```
